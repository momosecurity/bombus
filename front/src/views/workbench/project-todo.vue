...
<template>
    <div>
        ...
        <div slot="header" class="f-local-header">
            <Form class="f-local-form" ref="formFilter" :model="formFilter" :rules="formFilterRule" inline>
                <FormItem prop="status">
                    <Input type="text" v-model="formFilter.detail" :placeholder="descMap.detail"></Input>
                </FormItem>
                <FormItem prop="time_point">
                    <Input type="text" v-model="formFilter.time_point" :placeholder="descMap.time_point"></Input>
                </FormItem>
                <FormItem>
        ...
        <Modal v-model="formDetailModal" title="具体事项">
        ...
        <Modal v-model="formModal" title="新增/更新" footer-hide>
            <Form ref="formData" :model="formData" :rules="formRule" :label-width="120">
                ...
                <FormItem :label="descMap.detail" prop="detail">
                    <Input type="textarea" :rows="5" v-model="formData.detail"></Input>
                </FormItem>
                <FormItem :label="descMap.time_point" prop="time_point">
                    <Input type="text" v-model="formData.time_point"></Input>
                </FormItem>
                <FormItem>
        ...
        data() {
            return {
                ...
                tableColumns: [
                    ...
                    { title: '具体事项', key: 'detail'},
                    // { title: '具体事项', key: 'detail', tooltip: true, className: 'click-detail' },
                    { title: '时间线', key: 'time_point', width: 180},
            ...
            updateRecord(name) {
                this.$refs[name].validate((valid) => {
                    if (!valid) {
                        ...
                        let postData = {...form}
                        postData['project'] = this.project_id
                        if (form.id) {
