    ...
    <div>
        ...
        <div slot="header" class="f-local-header">
            <Form class="f-local-form" ref="formFilter" :model="formFilter" :rules="formFilterRule" inline>
                <FormItem prop="conf_key">
                    <Input type="text" v-model="formFilter.conf_key" :placeholder="descMap.conf_key"></Input>
                </FormItem>
        ...
        <Modal v-model="formModal" title="更新/查看" footer-hide width="700px" :mask-closable="false">
            <Form ref="formData" :model="formData" :rules="formRule" :label-width="120">
                ...
                <FormItem label="名称" prop="conf_key">
                    <Input type="text" v-model="formData.conf_key"></Input>
                </FormItem>
                <FormItem label="描述" prop="desc">
                    <Input type="textarea" v-model="formData.desc"></Input>
                </FormItem>
                <FormItem label="参数值" prop="content">
                    <Input type="text" v-model="formData.content"></Input>
                </FormItem>
